...
![Roheline kuld — kas see on tõsi?](assets/roheline-kuld-kaanep.png)
...
![Rahustav roheline — vaimne tervis](assets/roheline-rahustav-varv.png)
...
![Kanepi kasutusalad — võimaluste puu](assets/kanepi-kasutusalad-puu.png)
...
![Must turg vs reguleeritud turg](assets/raha-voog-vordlus.png)
...
![Maksupesa suurus — aus võrdlus](assets/maksupesa-suurus.png)
...
![Rikkus jaotatakse inimestele](assets/rikkus-inimestele.png)

### "Eesti Tuleviku Fond" — kuidas jagada?

```mermaid
pie title Kuhu läheb kanepimaksu 25 mln €?
    "Päikesepargid + salvestus" : 40
    "Tööstus ja robotid" : 30
    "Basic income pilot" : 20
