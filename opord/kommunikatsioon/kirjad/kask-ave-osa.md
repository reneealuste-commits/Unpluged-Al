# Kohandatud käsk: Ave Osa

**Saaja:** tallinn@waldorf.ee  
**Sidepakk:** P1-C-PERE
...
Võtmeisik; holistiline tugi

## Sinu eesmärk

Sidestada kogukond ja paranemis-teadlik tugi
...
```
Teema: Operatsioon Peegel — sinu roll: Võtmeisik
...
Sinu roll selles võrgustikus: Võtmeisik; holistiline tugi.

Sinu eesmärk: Sidestada kogukond ja paranemis-teadlik tugi.
...
Materjal: [lisa isiklik link — P1-C-PERE]
