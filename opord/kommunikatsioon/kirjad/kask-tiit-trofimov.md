# Kohandatud käsk: Tiit Trofimov

**Saaja:** info@tiittrofimov.ee  
**Sidepakk:** P1-A-KRIIS
...
Emotsioonide ja teadlikkuse töö

## Sinu eesmärk

Meeste ringid; taastumine pärast põhja
...
```
Teema: Operatsioon Peegel — sinu roll: Emotsioonide ja teadlikkuse töö
...
Sinu roll selles võrgustikus: Emotsioonide ja teadlikkuse töö.

Sinu eesmärk: Meeste ringid; taastumine pärast põhja.
...
Materjal: [lisa isiklik link — P1-A-KRIIS]
