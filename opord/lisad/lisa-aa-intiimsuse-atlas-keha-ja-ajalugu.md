...
Walsberg ja teaduslik ülevaade (üldine suund — **iga keha on individuaalne**):

| Teema | Mees (keskmine suund) | Naine (keskmine suund) |
|-------|------------------------|-------------------------|
| **Orgasmi fookus** | Sageli üks selge tipp; refraktsiooniperiood | Mitu teed — kliitor, G-tsoon, emakakael, täiskeha |
| **Aeg kuni orgasm** | Sageli lühem füüsiline tee | Sageli **vajab rohkem aega**, turvatunnet, foreplay |
| **Pea vs keha** | Visuaalne stimulatsioon tugev | Kontekst, emotsioon, turvalisus loevad rohkem |
| **„Teesklemine"** | Esineb | Uuringud ja Epp Kärsin: **üle 90%** naistest on orgasmi teeselnud või teesklevad |
| **Energia** | Tihti lineaarne: tipp → lakkamine | Võib olla **laineid**, mitu orgasmi, pikem nauding |
| **Stress** | Sageli „kapseldub" | Elab kehas — puudutus võib **vabastada** (või blokeerida, kui pole turvaline) |

> *Vau:* mees ja naine **ei ole katki**, kui nad ei „sobi" filmide mudelisse. Nad on **erinevad** — ja see on normaalne.

**Walsberg küsimused raamatust:**
- Miks tavaliselt mehed saavad orgasmi, aga naised mitte — kas see **peab** nii olema?
- Mis vahe on „tavalisel seksil" ja **teadlikul seksuaalsusel**?
- Milline on nais- ja meesenergia erinevus — ja miks see loeb suhtes?

**Seos Lisa W-ga:** austus algusest — ka intiimsuses. Keha ei ole objekt. Keha on **partner**.

---

## 2. Milliseid orgasme on võimalik tekitada?

> *See ei ole garantii ega retsept. See on **teadlikkuse kaart** — et tead, mis on võimalik.*

### Naisele (Walsberg + Epp Kärsin koolitused)

| Tüüp | Kus / kuidas | Märkus |
|------|--------------|--------|
| **Kliitoraalne** | Kliitor ja ümbrus | Kõige levinum tee; paljud naised **ainult** siit |
| **G-punkti / vaginaalne** | Esise sein, ~5–8 cm sügavus | Ei ole eraldi „magic button" kõigile — **uuri partneriga** |
| **Emakakaela / sügav** | Sügav puudutus, aeglane tempo | Epp: „emakakaela orgasm" — vajab turvatunnet, aega |
| **Sisemine / täiskeha** | Hingamine, aeglane tempo, kogu keha | „Maa ja taeva piirid kaovad" (Epp) |
| **Kombineeritud** | Mitu tsooni korraga | Sageli **võimsaim** — aga mitte kiirustades |

### Mehele

| Tüüp | Märkus |
|------|--------|
| **Ejakulatoorne** | Levinud mudel — mitte ainus võimalik kogemus |
| **Prostata / sisemine** | Vähem räägitud; vajab usaldust ja teadmist |
| **Kestev / edasi lükatud** | Lingam-massaaž (Epp Kärsin koolitused) — **ei pea** olema kiire lõpp |

### Ühine õppetund

```
Kiirus + häbi + teadmatus = teeskelmine ja tühi suhe
Aeg + turvalisus + teadlikkus = päris nauding mõlemale
```

**Lisa V:** uni ja stress — ilma puhkuseta keha ei avane. **Lisa Y:** stress kehas — intiimsus võib aidata, aga ei asenda teraapiat.

---

## 3. Vibraatori ajalugu — stress, arstid ja „hüsteeria"

> *Ajalugu, mida koolis ei räägi. Ava silmad — ja **kontrolli allikaid** (kriitiline mõtlemine).*

### Lühiajalugu

| Aeg | Mis juhtus |
|-----|------------|
| **Vana-Kreeka kuni 19. sajand** | „Hüsteeria" — lai diagnoos naistele (ärevus, migreen, „närvid") |
| **Arstide „ravi"** | Pelklik massaaž kuni „hüsteerilise paroksüsmini" — arstid **ei nimetanud seda orgasmiks** |
| **1883** | Joseph Mortimer Granville — **esimene elektromehaaniline vibraator** (musklitele; ta **eitas** kasutamist naistel) |
| **19.–20. sajand** | Vibraatorid müüdi arstidele, hiljem „massaaziseadmetena" |
| **1999** | Rachel Maines — *The Technology of Orgasm*: hüpotees, et vibraator **asendas arsti kätt** |
| **2018+** | Uued ajaloolased (Lieberman, Schatzberg): **esmaste allikate puudumine** — Maines võib olla liialdus |

### Mida see tähendab täna

| Narratiiv A (Maines) | Narratiiv B (kriitika) |
|----------------------|------------------------|
| Arstid tegid naistele orgasmi „raviks" | Elektrivibraator loodi **lihastele**; tõendid naiste „ravist" nõrgad |
| Vibraator = meditsiiniline tööriist stressi vastu | Tarbijaturg 1900ndatest — „massaaziseade" |
| Hüsteeria = represseeritud seksuaalsus | Diagnoos oli **poliitiline ja sooline** kontroll |

**Operatsiooni seis:** **mõlemad** narratiivid on õpetlikud. Punkt ei ole vaidlustada lõputult — punkt on: **keha naudingut on ajalooliselt kontrollitud, häbistatud ja medikaliseeritud.** Täna saad valida **teadlikkuse** — mitte häbi.

> *Stressi vabastamine kehas ei ole häbiväärne. See on **biokeemia** — nagu uni (Lisa V) või hingamine (URBN TIGER).*

---

## 4. Yoni massaaž — mis see on ja miks

**Yoni** (sanskriti keeles „ema, allikas") — **teadlik, austav** naise intiimse keha puudutus.

| Mis see ON | Mis see EI OLE |
|------------|----------------|
| Stressi ja pingete vabastamine kehas | Porr või jõuga „teenus" |
| Teadlikkus, aeg, turvalisus | Kiirus ja teesklmine |
...
1. Kas ma olen lugenud **Intiimsuse atlasi** — või ainult kuulnud sellest?
2. Kas ma tean, **millised orgasmid** on minu kehal võimalikud?
3. Kas ma olen kunagi **teeselnud** — või partner minuga? Miks?

### B. Erinevus

4. Kas ma eeldan, et partner töötab **nagu mina**?
5. Kas ma annan **aega** — või ainult kiirust?
6. Mis on mehe ja naise **energia** erinevus minu suhtes?

### C. Ajalugu

7. Kas ma teadsin vibraatori **meditsiinilist** lugu?
8. Kas Maines vs kriitika — **mõlemad** on õpetlikud?
9. Miks kool ei räägi sellest — aga porr on kättesaadav?

### D. Tegevus

10. Kas ma panen end **kirja** Epp Kärsini koolitusele — või ainult loen?
11. Kas suhtes on **turvaline** rääkida ausalt?
12. Kas intiimsus on **armastus** — või ainult füüsiline tegevus?
...
| Ei | Jah |
|----|-----|
| Porra propageerimine | Teadlikkus ja austus |
| Meditsiiniline nõuanne | Uurimustöö + koolitus |
| Kohustus kasutada vibraatorit | Info ajaloost |
| Asendab teraapiat (Lisa H, P) | Täiendab pere rindejoont (Lisa E) |
...
*Lisa AA — Operatsioon „Peegel". Seksuaalharidus, mitte pornograafia. Alaealiste puhul: vanemad ja kool (Lisa J). Kriisis: Eluliin 655 8088.*
