...
│ Ambros (Harku) │ │ KV psühh (TK süsteem) │ │ jujutud.ee │ │ hajutatud ettevõtjad (vt 3.13) │
└──────────────────┘ └───────────────────────┘ └───────────────────┘ └───────────────────────────────────┘
```
...
| Nimi | Roll / kontekst | Tsitaadi tuum |
|------|-----------------|---------------|
| Raul Eamets | Klient | Praktiline juhtimine, mis töötab päriselus |
| Triin Limbach | Klient | Selgus ja vastutus meeskonnas |
| Jonna Pechter | Klient | Extreme Ownership põhimõtted muutsid juhtimist |
| Kairo Sulbi | Klient | Koolitus, mis jäi meelde ja rakendus |
| Renno Reinurm | Klient | Aus, otsekohene, tulemuslik |
...
## 3. Allüksuste kollektiivsed ülesanded

### 3.1 Strateegiline tase

**Eesmärk:** Ühendada riiklik julgeolek, kodaniku vastutus ja avalik sõnum ilma propaganda keeleta.
...
| 4 | Kriisikommunikatsiooni standardid (koos StratKom-iga) |

### 3.2 Operatsiooni koordineerimisüksus (Renee Aluste)

**Eesmärk:** Koordineerida sõnumit, võrgustikku ja tegevust rahva tasandil.
...
**Eesmärk:** Mereväe-kultuuriga meeskond — tugevad, eneseteadlikud ettevõtjad.

| Ülesanne | Kirjeldus |
|----------|-----------|
| 1 | ~20 liikme treeningud: juhtimine, meeskond, vastupidavus |
| 2 | Mereväe distsipliini levitamine tsiviilkanalisse |
| 3 | Ühised treeningud Renee Alustega ja võrgustikuga |

### 3.7 Vanglateenistus / Viru vangla

**Eesmärk:** Inimesekeskne juhtimine raskes keskkonnas — kriisivalmidus ja meeskonnakultuur.
...
**Eesmärk:** Noorte vastupanuvõime koolides — vt täielik nimekiri **Lisa J**.

### 3.9 Teadlikkuse tase

**Eesmärk:** Sügavam ärkvelolek — mitu kanalit, üks missioon.
...
### 3.10 Kohalikud allüksused

| Üksus | Eesmärk |
|-------|---------|
| Noorte Kotkad (Järvsoo) | Isamaaline kasvatus, distsipliin, eeskuju noortele |
| Harku (Ambros) | Füüsiline vastupidavus, ju-jutsu, enesekaitse |

### 3.11 Veteranid ja tugi

| Üksus | Eesmärk |
|-------|---------|
| Eesti Kaitseväe Veteranid (Kinnunen) | Veteranide tugi, ausad lood, kogukond |
| Kaitseväe psühholoog (tervisekeskuse süsteem) | Vaimne tervis ja supervisioon — inimeste juhtimine, mitte protsesside kontroll |
...
### 4.1 Strateegiline tase

#### Riho Ühtegi — Strateegiline juht

![Riho Ühtegi](images/profiles/riho-uhtegi.jpg)

- **Roll:** Strateegiline eeskuju ja rahvuslik juhtimisvisioon
- **Eesmärk:** Riigikaitse mõistmine inimeste, mitte tankide kaudu
- **Ülesanne:** Avalik sõnum perede ja kodaniku vastutusest; eeskuju ilma dominantsita

#### Rene Toomse — Riigi ja valitsuse tase

![Rene Toomse](images/profiles/rene-toomse.jpg)

- **Roll:** Strateegiline nõustaja; valitsuse ja kodaniku sild
- **Eesmärk:** Infosõja mõistmine riiklikul tasandil
- **Ülesanne:** Ühendavad narratiivid; infosõja teemad ilma bürokraatiata
...
### 4.2 Operatsiooni koordineerimisüksus
...
- **Roll:** Co-Founder; Euroopa kaitsevõrgustik
- **Eesmärk:** Rahvusvaheline mõjutus ja koostöö
- **Ülesanne:** EL kaitseuuendused; Youth OÜ; strateegiline arendus

#### Priit Lilleväli — Instruktor, juhendaja
...
- **Ülesanne:** 300+ koolitust; 800+ juhendamistundi; podcast
...
- **Roll:** Head of Support and Service
- **Eesmärk:** Kliendikogemus ja protsessid
- **Ülesanne:** Operatiivne tugi koolitustele
...
- **Roll:** Her Way programmi juht
- **Eesmärk:** Naiste enesejuhtimine
- **Ülesanne:** Veebiseminarid; kogukonna ehitamine

#### Aet Tammis — Instruktor

- **Roll:** Her Way instruktor
- **Eesmärk:** Praktiline vastutus naiste kontekstis
- **Ülesanne:** Treeningud ja veebikohtumised

#### Karin Pohla — Instruktor

- **Roll:** Her Way instruktor
- **Eesmärk:** Enesejuhtimine emadele ja juhtidele
- **Ülesanne:** Koolitused ja mentorlus
...
### 4.6 MTÜ Team Pertinax

#### Aigar Ojaots — Kaasasutaja, juhatuse liige

- **Roll:** Mereväe-kultuuriga meeskonna eestvedaja (~20 liiget)
- **Eesmärk:** Eneseteadlikud, tugevad ettevõtjad
- **Ülesanne:** Treeningud; ühised sessioonid Renee Alustega
...
#### Ain Anslan — Viru vangla direktor
...
| Nimi | Asutus | Roll |
|------|--------|------|
| Ott Pärna | Techno TLN | Direktor |
| Birgit Vilgats | Techno TLN | Õppejuht |
| Andra Piirsalu | Techno TLN | Personalijuht |
| Ander Sile | Techno TLN | Inseneriharidus |
| Tõnu Armulik | Techno TLN | Arendusdirektor |
| Kristel Bankier | Techno TLN | Finants/partnerlus |
| Kristel Martis | Techno TLN | Turundus/kogukond |
| Toivo Pärnpuu | Techno TLN | IT |
| Mari Vavulski | Techno TLN | Muudatuste projektijuht |
| Johan-Elias Seljamaa | KVA | Rektor |
| Rainek Kuura | KVA | Õppeosakonna ülem |
| Indrek Ojasoo | KVA | Akadeemia veebel |
| Aarne Ermus | KVA | Juhtimise suund |
| Hannes Tamjärv | RaM Kool | Asutaja, nõukogu esimees |
| Sirje Toomla-Õige | RaM Kool | Direktor |
| Rein Rebane | RaM Kool | Direktor emeeritus |
| Katrin Rodi | RaM Kool | Pearaamatupidaja |
...
### 4.10 Kohalikud allüksused

#### Peeter Järvsoo — Noorte Kotkad

- **Roll:** Rühma vanem
- **Eesmärk:** Noorte isamaaline kasvatus
- **Ülesanne:** Distsipliin, meeskond, eeskuju enne sotsiaalmeediat
...
- **Roll:** Kaitseväe psühholoog tervisekeskuse süsteemis
- **Eesmärk:** Vaimne tervis; inimeste juhtimine protsesside asemel
- **Ülesanne:** Juhtide ja tugispetsialistide psühholoogiline tugi; Steigeri põhimõtted praktikas (anonüümne roll)
...
| 15 | What it takes to be a US Army Ranger | **Renee Aluste**, Louis Zezeran |
| 16 | 4 Steps to Improve Leadership | Remo Ojaste, Louis Zezeran |
| 17 | Theory is boring — train as you fight | Robert Käsper, Louis Zezeran |
| 18 | A Typical Day in Afghanistan | Priit Lilleväli, Louis Zezeran |
| 19 | Leadership Lessons from Comedy Estonia | Louis Zezeran |
| 20 | Haara initsiatiiv | Martin Jõesaar |
| 21 | Uju või upu — Lauri „Doc" Lemming | **Lauri „Doc" Lemming** |
| 22 | Läbi raskuste edasi — Tõnu Sillaots | **Tõnu Sillaots** |
| 23 | Aga miks mina? — Martin Siimann | **Martin Siimann** |
| 24 | „Lahinguväljal" enne ajateenistust — Priit Lilleväli | Priit Lilleväli |
| 25 | Juhtimine, ego, alandlikkus — Eerik Heldna | Eerik Heldna, Remo Ojaste |

### Podcasti väliskülalised (kokkuvõte)

| Nimi | Kontekst | Operatsioonis väärtus |
|------|----------|----------------------|
| Kai Saard | Personalijuhtimine (PARE) | Lihtne juhtimine, selgus |
| Boris Ümarik | Produktiivsusklubi | Isese juhtimine, fookus |
| Janis Vanags | Kriisijuhtimine (CIREN) | Kriisivalmidus kodanikule |
| Lauri „Doc" Lemming | Lastekirurg, veteran | Alandlikkus, vastupidavus |
| Tõnu Sillaots | Veteran, päästja | Elu pärast kaotust |
| Martin Siimann | Reservohvitser | „Tee ära" mentaliteet |
| Hanno Pevkur | Kaitseminister | Riiklik julgeolek (viide ep 6) |
| Riho Terras | Kindral (res.) | Strateegiline kogemus (viide ep 6) |
| Enn Adoson | Kaitseväe vanemveebel | Meeskonna kultuur (viide ep 6) |
...
| Teema | Lisa / fail |
|-------|-------------|
| Renee Aluste eraldi profiil | `renee-aluste-profiil.md` |
...
*Lisa K täieneb, kui operatsiooniga liituvad uued allüksused või osalised. Järgmine samm: maakondlike kogukondade juhtide lisamine.*
